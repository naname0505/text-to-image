...
class GAN:
    ...
    def build_model(self):
        ...
        # train l76 input_tensors, valiaables, loss. outputs, checks = gan.build_model() is dead from this code
    ...
    def discriminator(self, image, t_text_embedding, reuse=False): # Fix this code, from `Flase` => `True` 
